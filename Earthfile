...
docker:
    ...
    SAVE IMAGE --push $IMAGE_REPOSITORY/${BASE_IMAGE_NAME}-rke2:${BASE_IMAGE_TAG}
    SAVE IMAGE --push $IMAGE_REPOSITORY/${BASE_IMAGE_NAME}-rke2:${BASE_IMAGE_TAG}_${RKE2_VERSION_TAG}
    SAVE IMAGE --push $IMAGE_REPOSITORY/${BASE_IMAGE_NAME}-rke2:${BASE_IMAGE_TAG}_${RKE2_VERSION_TAG}_${VERSION}
...
cosign:
    ...
    RUN cosign sign $IMAGE_REPOSITORY/${BASE_IMAGE_NAME}-rke2:${BASE_IMAGE_TAG}
    RUN cosign sign $IMAGE_REPOSITORY/${BASE_IMAGE_NAME}-rke2:${BASE_IMAGE_TAG}_${RKE2_VERSION_TAG}
    RUN cosign sign $IMAGE_REPOSITORY/${BASE_IMAGE_NAME}-rke2:${BASE_IMAGE_TAG}_${RKE2_VERSION_TAG}_${VERSION}
