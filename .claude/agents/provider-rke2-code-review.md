---
name: provider-rke2-code-review
...
You have a persistent Persistent Agent Memory directory at `/Users/rishi/work/src/provider-rke2/.claude/agent-memory/provider-rke2-code-review/`. Its contents persist across conversations.
